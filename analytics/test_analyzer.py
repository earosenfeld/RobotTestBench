...
class TestAnalyzer:
    ...
    def compute_metrics(self) -> TestMetrics:
        ...
        velocity = self.data['velocity'].values
    ...
    def generate_plots(self, save_dir: Path):
        ...
        # Position plot
        ax1.plot(self.data['elapsed_time'], self.data['position'], label='Position')
        ...
        # Velocity plot
        ax2.plot(self.data['elapsed_time'], self.data['velocity'], label='Velocity')
